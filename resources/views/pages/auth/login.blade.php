...
@section('content')
    <section class="login-section">
        <div class="row h-100">
            <div class="col-md-7 d-none d-md-block bg-primary">
                <div class="d-flex align-items-center justify-content-center" style="height: 100vh">
                    <div>
                        ...
                        <div class="text-white">
                            <h3 class="text-center font-weight-bold">Selamat Datang di Lumi Store</h3>
            ...
            <div class="col-md-5 d-flex justify-content-center align-items-center" style="background-color: white">
                <div class="login-form">
                    <div>
                        <h2 class="font-weight-bold text-center" style="color: #666666">Lumi Store</h2>
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-5">
                        <form action="{{ route('login') }}" class="form-group" method="POST">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <button type="submit" class="btn btn-login py-2 rounded-5 bg-primary text-white">Masuk</button>
                            </div>
                        </form>
                    </div>
                </div>
